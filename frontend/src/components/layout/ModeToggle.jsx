...
export default function ModeToggle() {
  ...
  return (
    <div className="flex bg-background-card rounded-pill p-1 border border-white/10 gap-0.5">
      {modes.map((mode) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 sm:px-3 md:px-4 py-1.5 rounded-pill text-xs sm:text-sm font-medium transition-all duration-200 whitespace-nowrap ${
              isActive
