    ...
    <div className="min-h-screen flex items-center justify-center bg-background-primary px-4">
      <div className="card w-full max-w-md shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-8">
          ...
          <h2 className="text-3xl font-heading font-semibold text-text-primary mb-2">Welcome Back</h2>
          <p className="text-text-secondary">Sign in to continue to MediBot</p>
        </div>
